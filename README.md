...
A dynamic and responsive blog platform built with React for the frontend, styled using Tailwind CSS, and powered by Node.js and Appwrite for backend services. The website includes user authentication (sign-in, sign-up), post creation, and a homepage that showcases all user posts in an intuitive interface.
